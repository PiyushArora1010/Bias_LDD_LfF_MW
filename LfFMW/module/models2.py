...
class ResNet_MW(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, grayscale):
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2)
        self.avgpool = nn.AvgPool2d(7, stride=1)
        self.fc = MemoryWrapLayer(512 * block.expansion, num_classes)
...
class ResNet_weights(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, grayscale, M = 100):
        self.inplanes = 64
        if grayscale:
            in_dim = 1
        else:
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2)
        self.avgpool = nn.AvgPool2d(7, stride=1)
        self.fc = WeightsAttention(512 * block.expansion, num_classes, M, M)
...
def ResNet18_MW(num_classes=10):
    """Constructs a ResNet-18 model."""
    model = ResNet_MW(block=BasicBlock, 
                   layers=[2, 2, 2, 2],
                   num_classes=num_classes,
                   grayscale=False)
    return model

def ResNet34_MW(num_classes=10):
    model = ResNet_MW(block=BasicBlock, 
                   layers=[3, 4, 6, 3],
                   num_classes=num_classes,
                   grayscale=False)
...
class ResNet_attention(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, grayscale):
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2)
        self.avgpool = nn.AvgPool2d(7, stride=1)
        self.fc = AttentionLayer(512 * block.expansion, num_classes)
...
def ResNet18_attention(num_classes=10):
    """Constructs a ResNet-18 model."""
    model = ResNet_attention(block=BasicBlock, 
                   layers=[2, 2, 2, 2],
                   num_classes=num_classes,
                   grayscale=False)
    return model

def ResNet34_attention(num_classes=10):
    model = ResNet_attention(block=BasicBlock, 
                   layers=[3, 4, 6, 3],
                   num_classes=num_classes,
                   grayscale=False)
...
def ResNet18_weights(num_classes=10):
    """Constructs a ResNet-18 model."""
    model = ResNet_weights(block=BasicBlock, 
                   layers=[2, 2, 2, 2],
                   num_classes=num_classes,
                   grayscale=False)
    return model

def ResNet34_weights(num_classes=10):
    model = ResNet_weights(block=BasicBlock, 
                   layers=[3, 4, 6, 3],
                   num_classes=num_classes,
                   grayscale=False)
...
class ResNet_approach(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, grayscale):
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2)
        self.avgpool = nn.AvgPool2d(7, stride=1)
        self.fc = Approach(512 * block.expansion, num_classes)
    ...
    def forward(self,x,memory_input,weights,return_weights):
        x_out = self.forward_encoder(x)
        mem_out = self.forward_encoder(memory_input)
        out_mw = self.fc(x_out,mem_out,weights,return_weights)
        return out_mw

def ResNet18_approach(num_classes=10):
    """Constructs a ResNet-18 model."""
    model = ResNet_approach(block=BasicBlock, 
                   layers=[2, 2, 2, 2],
                   num_classes=num_classes,
                   grayscale=False)
    return model

def ResNet34_approach(num_classes=10):
    model = ResNet_approach(block=BasicBlock, 
                   layers=[3, 4, 6, 3],
                   num_classes=num_classes,
                   grayscale=False)
...
def get_model(model_tag, num_classes):
    ...
    if model_tag == "ResNet18":
        ...
        print('bringing no pretrained resnet34 ...')
...
dic_models_2 = {
    'resnet18_C': ResNet18,
    'resnet34_C': ResNet34,
    'resnet18_C_MW': ResNet18_MW,
    'resnet34_C_MW': ResNet34_MW,
    'resnet18_attention': ResNet18_attention,
    'resnet34_attention': ResNet34_attention,
    'resnet18_C_approach': ResNet18_approach,
    'resnet34_C_approach': ResNet34_approach,
}